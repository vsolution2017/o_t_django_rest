...
urlpatterns = [
    ...
    url(r'^maquinarias/(?P<pk_contratista>[0-9]+)/(?P<fecha>\d{8})$', Maquinaria_view.as_view()),
    url(r'^sub_actividad/(?P<pk_actividad>[0-9]+)/(?P<fecha>\d{8})$', SubActividad_view.as_view()),
